...
<%!
	...
	String name, id, pw, phone1, phone2, phone3, gender, email;
...
<%
	...
	String query = "SELECT * FROM memebership WHERE id='" + id +"'";
...
%>
	...
	<form action="/jspMain/ModifyCheck" method="post">
		...
		-<input type="text" name="phone3" size="5" value=<%=phone2 %>><br>
		<%
		...
		이메일: <input type="text" name="email" size="30" value=<%=email %>><br>
